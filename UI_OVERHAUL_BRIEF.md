Board Game Night — UI/UX Overhaul Brief
...
Groups should feel like “rooms” or “clubs,” not plain rows.
...
Keep current structure:
	•	header
	•	segmented tabs
	•	Collection / Voting / Settings

Refine:
	•	stronger header
	•	cleaner invite code treatment
	•	better tab styling
	•	more consistent tab-specific actions
...
Intent: event console / session flow

This can become one of the most distinctive screens.

Needs:
	•	clear session stage hierarchy
	•	stronger current-action area
	•	more elegant results structure
	•	Results should feel like part of one session story
...
Visually:
	...
	•	avatar eventually becomes important here
